...
region = (4, 124, 896, 1300)    # Region coordinates/size (x, y, w, h) of game play window onscreen
...
def setup_game():
    global keyword_trigger, region, min_words
...
def clear():
    global keyword_trigger, game_content, region
    keyword_trigger = ''
    region = None
    return redirect(url_for('index'))
